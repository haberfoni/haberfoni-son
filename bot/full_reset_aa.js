...
async function fullResetAA() {
    console.log('=== FULL RESET AA News ===\n');

    // Delete ALL AA news (not just recent)
    console.log('1. Deleting ALL AA news...');
    ...
    else console.log('   ✅ Deleted ALL AA news.');

    // Run Scraper
    console.log('\n2. Running AA Scraper (fresh start)...');
    await scrapeAA();
    ...
    data.forEach((n, i) => {
        ...
        if (hasImg) {
            ...
            console.log('    ℹ️ No images in this article');
        }
    });
}
