...
const PhotoGalleryPage = () => {
    // Get Featured Album (first item)
    const featuredAlbum = photoGalleryItems[0];

    // Get Most Viewed (random 5 items for demo)
    const mostViewed = photoGalleryItems.slice(1, 6);

    // Get Latest Albums (all items)
    const latestAlbums = photoGalleryItems;
